...
| engine_mode | Aurora database engine mode. | string | `provisioned` | no |
...
| monitoring_interval | The interval (seconds) between points when Enhanced Monitoring metrics are engine_version | string | `0` | no |
